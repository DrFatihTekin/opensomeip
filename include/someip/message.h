...
class Message {
   public:
    ...
    uint8_t get_interface_version() const
    {
        return interface_version_;
    }
    void set_interface_version(uint8_t version)
    {
        interface_version_ = version;
    }
    ...
    ReturnCode get_return_code() const
    {
        return return_code_;
    }
    void set_return_code(ReturnCode code)
    {
        return_code_ = code;
    }
    ...
    {
        return message_id_.service_id;
    }
    void set_service_id(uint16_t service_id)
    {
        message_id_.service_id = service_id;
    }

    uint16_t get_method_id() const
    {
        return message_id_.method_id;
    }
    void set_method_id(uint16_t method_id)
    {
        message_id_.method_id = method_id;
    }

    uint16_t get_client_id() const
    {
        return request_id_.client_id;
    }
    void set_client_id(uint16_t client_id)
    {
        request_id_.client_id = client_id;
    }

    uint16_t get_session_id() const
    {
        return request_id_.session_id;
    }
    void set_session_id(uint16_t session_id)
    {
        request_id_.session_id = session_id;
    }
    ...
    {
        return someip::is_request(message_type_);
    }
    bool is_response() const
    {
        return someip::is_response(message_type_);
    }
    bool uses_tp() const
    {
    ...
    {
        return someip::is_success(return_code_);
    }
