...
const Endpoint SOMEIP_SD_MULTICAST_ENDPOINT("239.118.122.69", 30490,
...
Endpoint::Endpoint() : address_("127.0.0.1"), port_(30490), protocol_(TransportProtocol::UDP)
{
}
...
{
    return address_ == other.address_ && port_ == other.port_ && protocol_ == other.protocol_;
}
